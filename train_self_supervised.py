...
train_ngh_finder = get_neighbor_finder(train_data, args.uniform) # 用来寻找某一时间点时某一个node的neighbor
...
train_rand_sampler = RandEdgeSampler(train_data.sources, train_data.destinations)   # 随机生成train中src到des的edge的list
val_rand_sampler = RandEdgeSampler(full_data.sources, full_data.destinations, seed=0) # 随机生成full中src到des的edge的list
nn_val_rand_sampler = RandEdgeSampler(new_node_val_data.sources, new_node_val_data.destinations,
                                      seed=1) # 随机生成new node val中src到des的edge的list
test_rand_sampler = RandEdgeSampler(full_data.sources, full_data.destinations, seed=2) # 随机生成test中src到des的edge的list
